 ...
 */
export declare const VALIDATION_OBLIGATIONS: readonly ["validation:boundary-accepted", "validation:boundary-rejected", "validation:no-side-effect-on-reject", "validation:error-message-explicit", "validation:envelope-shape-stable"];
export type ValidationObligation = (typeof VALIDATION_OBLIGATIONS)[number];
