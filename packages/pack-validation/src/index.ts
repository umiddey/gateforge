...
export {
  createValidationDetector,
  VALIDATION_SCHEMA_KIND,
  type ValidationDetector,
  type ValidationDetectorOptions,
  type ValidationResourceId,
} from './detector.js';
export { VALIDATION_OBLIGATIONS, type ValidationObligation } from './obligations.js';
import { createValidationDetector } from './detector.js';
/** The default CLI in-process plugin module: `{ discover(paths) }`. */
export default createValidationDetector();
