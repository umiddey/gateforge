...
export { createEvidence, claimsFromAnnotations, resourceIdOfClaim, SURFACE_DESCRIPTOR_VERSION, type EvidenceApi, type Receipt, type PersistenceOutcome, type WitnessRecord, type SurfaceDescriptor, } from './fixture/evidence.js';
...
export type { WitnessOptions, WitnessHandle, EvidenceAdapter, AdapterContext, RecordsRequest, RecordsResponse, PersistenceRequest, PersistenceResponse, SessionCredential, SessionOpenRequest, SessionOpenResponse, SessionCloseRequest, SessionCloseResponse, ExpectedSetRequest, ExpectedSetResponse, ExpectedTestRegistration, ExecutionTraceResponse, } from './witness/types.js';
 ...
 */
export { appendSpoolEvent, readSpoolEvents, spoolPathFor, startSupervisorSpoolDrain, SupervisorClient, DEFAULT_DRAIN_POLL_MS, } from './supervisor/index.js';
