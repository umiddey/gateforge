...
export { createEvidence, claimsFromAnnotations, resourceIdOfClaim, type EvidenceApi, type Receipt, type PersistenceOutcome, type WitnessRecord, } from './fixture/evidence.js';
...
export type { WitnessOptions, WitnessHandle, EvidenceAdapter, AdapterContext, RecordsRequest, RecordsResponse, PersistenceRequest, PersistenceResponse, } from './witness/types.js';
