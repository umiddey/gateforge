...
const hookScriptTemplate = (gateArgs) => `// Cross-platform entry for the blocking static gate (generated by
 ...
 */
export function ensureHookScript(io, engineRoot, gateArgs = ['check', '--changed']) {
...
export function ensureBlockingWiring(io, engineRoot, gateArgs = ['check', '--changed']) {
