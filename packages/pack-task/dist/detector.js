 ...
 */
function scanFile(relPath, text, findings) {
    const detections = [];
...
function matchRegisterLine(line) {
 ...
 */
function extractTargetModels(text, taskName) {
 ...
 * dashes.
 */
function bareResourceName(name) {
 ...
 */
function finalize(detections, findings, unresolved, scanned = []) {
