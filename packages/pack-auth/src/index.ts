...
export {
  ...
  validateAuthEntityAdapter,
  type AuthEntityAdapter,
  type AuthAdapterContext,
  type NormalizedAuthEntity,
  type AuthEntityAdapterValidation,
} from './adapter-schema.js';
export {
  AUTH_OBLIGATION_CONTRACTS,
  obligationId,
  type AuthObligationContract,
} from './obligations.js';
