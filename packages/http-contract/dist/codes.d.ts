...
export declare const HTTP_PATH_DYNAMIC = "HTTP_PATH_DYNAMIC";
/** A method expression the detector cannot resolve to a concrete verb. */
export declare const HTTP_METHOD_DYNAMIC = "HTTP_METHOD_DYNAMIC";
/** A FastAPI router prefix/include prefix that is not a provable literal. */
export declare const FASTAPI_PREFIX_UNRESOLVED = "FASTAPI_PREFIX_UNRESOLVED";
