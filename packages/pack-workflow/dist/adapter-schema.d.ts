 ...
 * data-fields pass.
 */
export declare const WorkflowAdapterSchema: z.ZodObject<{
    ...
    readEntity: z.ZodUnknown;
    readAuditLog: z.ZodUnknown;
    attemptTransition: z.ZodUnknown;
    allowedTransition: z.ZodUnknown;
}, z.core.$strict>;
 ...
 */
export declare function validateWorkflowAdapter(value: unknown): WorkflowAdapterValidation;
/**
 ...
 */
export declare function projectAuditRow(raw: unknown): AuditRow | null;
/**
 ...
 */
export declare function auditLogContainsTransition(rows: readonly unknown[], target: {
    actor: string;
    from: string;
    to: string;
}): boolean;
