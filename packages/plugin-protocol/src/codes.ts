...
export function isProtocolFailure(value: unknown, code?: ProtocolFailureCode): value is ProtocolFailure {
  if (!(value instanceof ProtocolFailure)) return false;
 ...
 */
export function formatDiagnostic(failure: ProtocolFailure): string {
