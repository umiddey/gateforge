 ...
 *   429 at attempt 4.
 */
export declare const WEBHOOK_OBLIGATION_CONTRACTS: readonly ["webhook:signature-accepted", "webhook:signature-rejected", "webhook:malformed-rejected", "webhook:replay-idempotent", "webhook:retry-bounded"];
/** One webhook obligation contract name. */
export type WebhookObligationContract = (typeof WEBHOOK_OBLIGATION_CONTRACTS)[number];
/**
 ...
 */
export declare function obligationId(resourceId: string, contract: WebhookObligationContract): string;
