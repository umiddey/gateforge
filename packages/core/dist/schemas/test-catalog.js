...
export const SUPPORTED_TEST_RUNNERS = ['playwright', 'pytest'];
/**
    ...
    for (let index = 0; index < catalog.entries.length; index += 1) {
        ...
        if (previous !== undefined) {
            ctx.addIssue({
                ...
                message: `duplicate logical key '${entry.logicalKey}' — sources: ` +
 ...
 */
export function deriveLogicalKey(input) {
