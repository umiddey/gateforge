 ...
 */
export { COVERAGE_OPERATIONS, CoverageOperationSchema, CoveragePolicySchema, CoverageTableSchema, CoverageDispositionSchema, } from './schemas/coverage-policy.js';
/** Inferred coverage-policy types. */
export type { CoverageOperation, CoveragePolicy, CoverageTable, CoverageDisposition, } from './schemas/coverage-policy.js';
/**
 ...
 */
export { SUPPORTED_TEST_RUNNERS, TestRunnerSchema, TestKindSchema, DiscoveryStatusSchema, ReconciliationStatusSchema, RuleEvidenceSchema, KindSignalSchema, WeakSignalSchema, CategorySignalSchema, SuppressionSignalKindSchema, SuppressionSignalSchema, TestCatalogEntrySchema, CatalogParseErrorSchema, RunnerSummarySchema, TestCatalogSchema, deriveLogicalKey, } from './schemas/test-catalog.js';
/** Inferred test-catalog types. */
export type { TestRunner, TestKind, DiscoveryStatus, ReconciliationStatus, RuleEvidence, KindSignal, WeakSignal, CategorySignal, SuppressionSignalKind, SuppressionSignal, TestCatalogEntry, CatalogParseError, RunnerSummary, TestCatalog, CatalogUnresolved, } from './schemas/test-catalog.js';
/**
 ...
 */
export type { RunnerCapability, RunnerCapabilities, RunnerTestInstance, RunnerSelection, RunnerExecutionEnv, RunnerInstanceOutcome, RunnerExecutionEnvelope, TestRunnerAdapter, } from './schemas/runner-adapter.js';
/**
...
export type { CoverageInventoryTable, MappedCoverage, CoverageConfigError, CoverageBlockingFinding, CoveragePolicyResult, } from './policy/index.js';
/**
 ...
 */
export { registerContractCapabilities, capabilityFor, allCapabilities, type ContractCapability, type ContractAvailability, } from './verdict/index.js';
/**
 ...
 */
export { causeForVerdict, capabilityGap, strictCapabilityGaps, type VerdictCause, type CapabilityGap, } from './verdict/index.js';
/**
 ...
 */
export { resolveTestMappings, mappingSuggestions, mappingGradingClaims, } from './mapping/resolve.js';
/** Inferred mapping-resolver types. */
export type { ResolveMappingsInput, ResolvedMappings, ObligationBindings, ResolvedClaimBinding, MappingProblem, MappingProblemCause, MappingOrigin, TestInstanceRef, PriorRunHint, MappingSuggestionsInput, MappingSuggestion, MappingSuggestionCause, SuggestionCandidate, } from './mapping/resolve.js';
/**
 ...
 */
export { EXECUTION_RESULT_DOMAIN, SELECTION_DOMAIN, ExecutionResultSchema, PlannedInstanceSchema, ExecutedOutcomeSchema, InstanceStatusSchema, SupervisionFindingSchema, TracedSessionSchema, TracedTestSchema, executionResultDigestOf, selectionDigestOf, } from './schemas/execution-result.js';
/** Inferred execution-result types. */
export type { ExecutionResult, PlannedInstance, ExecutedOutcome, InstanceStatus, SupervisionFinding, TracedSession, TracedTest, } from './schemas/execution-result.js';
/**
...
/** Supervision types. */
export type { PlannedInstanceInput, ExecutedOutcomeInput, SupervisionEnvelopeInput, SupervisionFinding as SupervisionFindingInput, SupervisionResult, TracedSession as TracedSessionInput, TracedTest as TracedTestInput, ExpectedTestInput, } from './supervision/index.js';
/**
...
export type { ParseAudit, ParseAuditEntry, ParseErrorRuleInput, ParseErrorRuleResult, StubDetectorOptions, StubDetectorResult, } from './testing/index.js';
/**
...
export type { DetectorContribution, EvaluatorVerdict, GateRunResult, ObligationEvaluator, ObligationEvaluatorInput, GateRunVerdict, RunGatesInput, } from './testing/index.js';
/**
...
export type { RedProbe, RedProbeRecord, VitestRunOptions, VitestRunResult, } from './testing/index.js';
